    ...
    <body>
                ...
                <div class="col-md-9">
                    <form id="hotelForm" name="hotelForm" method="POST" action="<%response.encodeURL("${contextPath}/hdc");%>">
                        <!-- <table>
                             ...
                             <tr>    <td>Notes:</td>    <td><TextArea name="notes" id="notes" rows="5">${selectedHotel.notes}</textarea></td>    </tr>
                         </table>-->
                        <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-5">
                                <table>
                                    <tr><td>ID:</td>    <td><input type="text" id="id" readonly name="id" value="${selectedHotel.hotelId}"/></td></tr>
                                    <tr><td>Street Address:</td>    <td><input type="text" id="street" name="street" value="${selectedHotel.streetAddress}"/></td>  </tr>   
                                    <tr>    <td>State:</td>    <td><input type="text" id="state" name="state" value="${selectedHotel.state}"/></td>    </tr>
                                    <tr>    <td>Notes:</td>    <td><TextArea name="notes" id="notes" rows="5">${selectedHotel.notes}</textarea></td>    </tr>
</table>
                       </div>
                        <div class="col-lg-5">
		...
		<script src="js/bootstrap.min.js"></script>
            ...
            $('#search').click(function () {
                    ...
                    var colName = $("#colSelect").val();
                    var val = $("#val").val();
                    
                    $('#hotelSearchForm').attr("action", "?colName=" + colName + "&val="+val+"&op=search");
